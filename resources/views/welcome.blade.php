...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="#">CV PODOMORO MAKASSAR</a>
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link underline" href="">Tentang Kami</a>
				</li>
				<li class="nav-item">
					<a class="nav-link underline" href="">Produk Kami</a>
				</li>
				<li class="nav-item">
	...
	<div class="content">
		...
		<h3>Temukan Tepung Sagu dan Olahan Tepung Sagu Terbaik untuk Anda</h3>
	</div>
	<div class="container">
		<div class="products">
