    ...
    <div class="container">
      <div class="login-wrapper">
        ...
        @endif
          ...
          <p class="message">Belum punya akun? <a href="/register">Buat Akun</a></p>
          <p class="message">Lupa Password? <a href="{{ route('password.request') }}">Reset Password Via Email</a></p>
        </form>
      </div>
    </div>
    <!-- Scripts -->
